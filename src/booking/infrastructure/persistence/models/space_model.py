...
class SpaceModel(Base):
    ...
    min_duration_minutes: Mapped[int] = mapped_column(Integer, default=30, nullable=False)
    max_duration_minutes: Mapped[int] = mapped_column(Integer, default=480, nullable=False)
    min_advance_minutes: Mapped[int] = mapped_column(Integer, default=60, nullable=False)
